...
//     Alamat_P2: data.Alamat_P2 || "",
//     NPWP_P2: data.NPWP_P2 || "",
//     Biaya_Pekerjaan: typeof data.Biaya_Pekerjaan === 'number' ? data.Biaya_Pekerjaan : 0, // cek apakah data adalah number
//     terbilang_1: data.terbilang_1 || "",
//     Jangka_Waktu_Pelaksanaan: typeof data.Jangka_Waktu_Pelaksanaan === 'number' ? data.Jangka_Waktu_Pelaksanaan : 0,
//     terbilang_2: data.terbilang_2 || "",
//     Jangka_Waktu_Pemeliharaan: typeof data.Jangka_Waktu_Pemeliharaan === 'number' ? data.Jangka_Waktu_Pemeliharaan : 0,
//     terbilang_3: data.terbilang_3 || "",
//     TKDN: typeof data.TKDN === 'number' ? data.TKDN : 0,
//     Terbilang_TKDN: data.Terbilang_TKDN || "",
//     Tanggal_Penetapan: data.Tanggal_Penetapan || "",
//     Perdir_PBJ: data.Perdir_PBJ || "",
//     Nomor_Nodin: data.Nomor_Nodin || "",
