...
<template>
  <div class="login-container">
    ...
    <div class="moving-text-container">
      <p class="moving-text">
        INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY •INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY • INDONESIA MARITIME GATEWAY •
      </p>
    </div>
